// The namespace for the WinForms application
namespace WinFormsParallelLoopApp
{
    // The partial class for the main form
    partial class ParallelLoopForm
    {
        ...
        {
            // Create a new group box for the file processor
            this.FileProcessorGroup = new System.Windows.Forms.GroupBox();

            // Create a button for processing JPGs
            ...
            // Create a label for the results text box
            this.label2 = new System.Windows.Forms.Label();

            // Create a button for processing a folder
            this.FolderProcessButton = new System.Windows.Forms.Button();

            // Create a button for browsing for a folder to process
            this.FolderBrowseButton = new System.Windows.Forms.Button();

            // Create a text box for the folder to be processed
            this.FolderToProcessTextBox = new System.Windows.Forms.TextBox();

            // Create a label for the folder to process text box
            this.label1 = new System.Windows.Forms.Label();

            // Create a new folder browser dialog for selecting a folder
            this.folderToProcessDialog = new System.Windows.Forms.FolderBrowserDialog();

            // Create a button for cancelling the operation
            this.CancelButton = new System.Windows.Forms.Button();

            this.FileProcessorGroup.SuspendLayout();
            this.SuspendLayout();
            // Configure the file processor group box
            ...
            // Configure the process JPGs button
            ...
            // Configure the results text box
            ...
            // Configure the folder process button
            ...
            // Configure the folder browse button
            ...
            // Configure the folder to process text box

namespace WorkingWithTimers {
    ...
    partial class TimerForm {
        ...
        private void InitializeComponent() {
            // Create a group box for the timer
            ...
            // Create a group box for the threading timer
            this.groupBox1 = new System.Windows.Forms.GroupBox();
            // Create a stop threading timer button
            this.stopThreadingTimerButton = new System.Windows.Forms.Button();
            // Create a start threading timer button
            this.startThreadingTimerButton = new System.Windows.Forms.Button();
            // Suspend layout for both group boxes
            ...
            // timerGroupBox
            // 
            // Add the stop and start timer buttons and set the location and size of the group box
            ...
            // stopTimerButton
            // 
            // Set the location and size of the stop timer button and add a click event listener
            ...
            // startTimerButton
            // 
            // Set the location and size of the start timer button and add a click event listener
            ...
            // groupBox1
            // 
            // Add the stop and start threading timer buttons and set the location and size of the group box
            ...
            // 
            // Set the location and size of the stop threading timer button and add a click event listener
            ...
            // 
            // Set the location and size of the start threading timer button and add a click event listener
            ...
            // TimerForm
            // 
            // Set the size of the form and add the group boxes
            ...
            // Resume layout for both group boxes
